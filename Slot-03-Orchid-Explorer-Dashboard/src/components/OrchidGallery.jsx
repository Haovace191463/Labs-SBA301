                ...
                <Row className="g-4">
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="Purple orchid"/>
                    ...
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="Pink orchid"/>
                            <Card.Body className="d-flex flex-column">
                    ...
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="White orchid"/>
                            <Card.Body className="d-flex flex-column">
                    ...
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="Yellow orchid"/>
                            <Card.Body className="d-flex flex-column">
                    ...
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="Orange orchid"/>
                            <Card.Body className="d-flex flex-column">
                    ...
                    <Col xs={12} sm={6} lg={4}>
                        <Card className="h-100 orchid-card shadow-sm">
                            <Card.Img variant="top" src="/images/img.png" alt="Blue orchid illustration"/>
                            <Card.Body className="d-flex flex-column">
